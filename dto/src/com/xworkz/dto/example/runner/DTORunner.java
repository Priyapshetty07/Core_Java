...
public class DTORunner {
	...
	public static void main(String[] args) {
		...
		System.out.println(name.concat(" ").concat(clr).concat(" ").concat(clr).concat(" ")
				.concat(String.valueOf(bluetoothDTO.gethZ())).concat(" ")
				.concat(String.valueOf(bluetoothDTO.getPrice())));
		...
		System.out.println(name1.concat(" ").concat(String.valueOf(cementDTO.getkG())).concat(" ")
				.concat(String.valueOf(cementDTO.getPrice())).concat(" ").concat(String.valueOf(cementDTO.isIsiMark()))
				.concat(String.valueOf(cementDTO.isGypSum())));
		...
		System.out.println(chargerDTO.getBrand().concat(" ").concat(chargerDTO.getColor()).concat(" ")
				.concat(String.valueOf(chargerDTO.getPrice()).concat(" "))
				.concat(String.valueOf(chargerDTO.getPort())));
		...
		System.out.println(solarDTO.getBrand().concat(" ").concat(solarDTO.getColor()).concat(" ")
				.concat(String.valueOf(solarDTO.getPrice()).concat(" "))
				.concat(String.valueOf(solarDTO.getLength()).concat(" "))
				.concat(String.valueOf(solarDTO.getCapacity()).concat(" ")));
		...
		System.out.println(statueDTO.getBrand().concat(" ").concat(statueDTO.getColor()).concat(" ")
				.concat(String.valueOf(statueDTO.getPrice()).concat(" "))
				.concat(String.valueOf(statueDTO.getSize()).concat(" ")));
		...
		System.out.println(dishDTO.getBrand().concat(" ").concat(dishDTO.getColor()).concat(" ")
				.concat(String.valueOf(dishDTO.getPrice()).concat(" "))
				.concat(String.valueOf(dishDTO.getNoOfChannels()).concat(" ")));
		...
		System.out.println(cmp.concat(" ").concat(clr1).concat(" ").concat(set1).concat(" ")
				.concat(String.valueOf(vehicleDTO.getPirce())).concat(" ").concat(String.valueOf(vehicleDTO.isType())));
	}
